...
class Persona
{
   ...
   function __construct(int $id,string $identificacion,string $nombre1,string $nombre2,string $apellido1,string $apellido2,DateTime $fechaNacimiento,string $telefonoCelular,string $telefonoDomicilio,string $correoElectronico,int $idGenero,string $idUbicacionDomicilioPais,string $idUbicacionDomicilioProvincia,string $idUbicacionDomicilioCanton,string $idUbicacionDomicilioParroquia,string $direccionDomicilio,int $idEstadoCivil,string $idUbicacionNacimientoPais,string $idUbicacionNacimientoProvincia,string $idUbicacionNacimientoCanton,string $idUbicacionNacimientoParroquia,double $idIngresos,int $idEtnia,int $idTipoSangre,int $numeroHijos,int $idOcupacion,string $carnetConadis,int $idTipoDiscapacidad,double $porcentajeDiscapacidad,string $nombrePadre,int $paisOrigenPadre,int $idNivelEstudioPadre,string $nombreMadre,int $paisOrigenMadre,int $idNivelEstudioMadre,longblob $foto){
      $this->id = $id;
