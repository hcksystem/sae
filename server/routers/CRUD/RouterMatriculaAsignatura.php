...
include_once('../controladores/CRUD/Controladormatriculaasignatura.php');
class RouterMatriculaAsignatura extends RouterBase
{
   public $controlador;

   function __construct(){
      parent::__construct();
      $this->controlador = new Controladormatriculaasignatura();
   }
   function route()
   {
