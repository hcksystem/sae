...
export class MatriculaComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: MatriculaService) {
   ...
   isValid(entidadPorEvaluar: Matricula): boolean {
      return true;
   }
   ...
   update(entidadParaActualizar: Matricula): void {
   ...
   delete(entidadParaBorrar: Matricula): void {
