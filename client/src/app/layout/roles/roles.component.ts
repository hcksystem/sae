...
export class RolesComponent implements OnInit {
   ...
   isValid(entidadPorEvaluar: Roles): boolean {
      return true;
   }
   ...
   crearEntidad(): Roles {
      const nuevoRoles = new Roles();
      nuevoRoles.id = 0;
      return nuevoRoles;
   }

   add(entidadNueva: Roles): void {
   ...
   update(entidadParaActualizar: Roles): void {
   ...
   delete(entidadParaBorrar: Roles): void {
   ...
   onSelect(entidadActual: Roles): void {
