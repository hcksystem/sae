...
export class ParcialComponent implements OnInit {
   ...
   isValid(entidadPorEvaluar: Parcial): boolean {
      return true;
   }
   ...
   crearEntidad(): Parcial {
      const nuevoParcial = new Parcial();
      nuevoParcial.id = 0;
      return nuevoParcial;
   }

   add(entidadNueva: Parcial): void {
   ...
   update(entidadParaActualizar: Parcial): void {
   ...
   delete(entidadParaBorrar: Parcial): void {
   ...
   onSelect(entidadActual: Parcial): void {
