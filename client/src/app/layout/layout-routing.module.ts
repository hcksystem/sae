...
const routes: Routes = [
   {
      ...
      children: [
         ...
         { path: 'asignaturasolicitudmatricula', loadChildren: './asignaturasolicitudmatricula/asignaturasolicitudmatricula.module#AsignaturaSolicitudMatriculaModule' },
         ...
         { path: 'tipoeducacioncontinua', loadChildren: './tipoeducacioncontinua/tipoeducacioncontinua.module#TipoEducacionContinuaModule' },
         { path: 'tipoingresos', loadChildren: './tipoingresos/tipoingresos.module#TipoIngresosModule' },
         { path: 'tipoinstitucionprocedencia', loadChildren: './tipoinstitucionprocedencia/tipoinstitucionprocedencia.module#TipoInstitucionProcedenciaModule' },
