...
export class DocumentoComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: DocumentoService) {
   ...
   crearEntidad(): Documento {
      const nuevoDocumento = new Documento();
      nuevoDocumento.id = 0;
      return nuevoDocumento;
   }

   add(entidadNueva: Documento): void {
   ...
   update(entidadParaActualizar: Documento): void {
   ...
   delete(entidadParaBorrar: Documento): void {
