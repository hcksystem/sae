...
export class AsistenciaComponent implements OnInit {
   ...
   entidadSeleccionada: Asistencia;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: AsistenciaService) {
   ...
   isValid(entidadPorEvaluar: Asistencia): boolean {
      return true;
   }
   ...
   crearEntidad(): Asistencia {
      const nuevoAsistencia = new Asistencia();
      nuevoAsistencia.id = 0;
      return nuevoAsistencia;
   }

   add(entidadNueva: Asistencia): void {
   ...
   update(entidadParaActualizar: Asistencia): void {
   ...
   delete(entidadParaBorrar: Asistencia): void {
   ...
   onSelect(entidadActual: Asistencia): void {
