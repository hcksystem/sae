...
export class EstudianteComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: EstudianteService) {
   ...
   isValid(entidadPorEvaluar: Estudiante): boolean {
      return true;
   }
   ...
   add(entidadNueva: Estudiante): void {
   ...
   update(entidadParaActualizar: Estudiante): void {
   ...
   delete(entidadParaBorrar: Estudiante): void {
   ...
   onSelect(entidadActual: Estudiante): void {
