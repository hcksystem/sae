...
export class TituloComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: TituloService) {
   ...
   isValid(entidadPorEvaluar: Titulo): boolean {
      return true;
   }
   ...
   update(entidadParaActualizar: Titulo): void {
   ...
   delete(entidadParaBorrar: Titulo): void {
   ...
   onSelect(entidadActual: Titulo): void {
