...
export class EnfermedadComponent implements OnInit {
   ...
   crearEntidad(): Enfermedad {
      const nuevoEnfermedad = new Enfermedad();
      nuevoEnfermedad.id = 0;
      return nuevoEnfermedad;
   }

   add(entidadNueva: Enfermedad): void {
   ...
   update(entidadParaActualizar: Enfermedad): void {
   ...
   delete(entidadParaBorrar: Enfermedad): void {
