...
@Component({
   ...
   templateUrl: './periodoacademico.component.html',
   styleUrls: ['./periodoacademico.component.scss']
})
...
export class PeriodoAcademicoComponent implements OnInit {
   ...
   isValid(entidadPorEvaluar: PeriodoAcademico): boolean {
      return true;
   }
   ...
   crearEntidad(): PeriodoAcademico {
      const nuevoPeriodoAcademico = new PeriodoAcademico();
      nuevoPeriodoAcademico.id = 0;
      return nuevoPeriodoAcademico;
   }

   add(entidadNueva: PeriodoAcademico): void {
   ...
   update(entidadParaActualizar: PeriodoAcademico): void {
   ...
   delete(entidadParaBorrar: PeriodoAcademico): void {
   ...
   refresh(): void {
      ...
      this.entidades = PeriodoAcademico[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: PeriodoAcademico): void {
