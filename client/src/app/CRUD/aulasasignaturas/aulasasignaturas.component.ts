...
@Component({
   selector: 'app-aulasasignaturas',
   templateUrl: './aulasasignaturas.component.html',
   styleUrls: ['./aulasasignaturas.component.scss']
})

export class AulasAsignaturasComponent implements OnInit {

   busy: Promise<any>;
   entidades: AulasAsignaturas[];
   ...
   isValid(entidadPorEvaluar: AulasAsignaturas): boolean {
      return true;
   }
   ...
   crearEntidad(): AulasAsignaturas {
      const nuevoAulasAsignaturas = new AulasAsignaturas();
      nuevoAulasAsignaturas.id = 0;
      return nuevoAulasAsignaturas;
   }

   add(entidadNueva: AulasAsignaturas): void {
   ...
   update(entidadParaActualizar: AulasAsignaturas): void {
   ...
   delete(entidadParaBorrar: AulasAsignaturas): void {
   ...
   refresh(): void {
      ...
      this.entidades = AulasAsignaturas[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: AulasAsignaturas): void {
