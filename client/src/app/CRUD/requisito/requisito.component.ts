...
export class RequisitoComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: RequisitoService) {
   ...
   isValid(entidadPorEvaluar: Requisito): boolean {
      return true;
   }
   ...
   crearEntidad(): Requisito {
      const nuevoRequisito = new Requisito();
      nuevoRequisito.id = 0;
      return nuevoRequisito;
   }

   add(entidadNueva: Requisito): void {
   ...
   update(entidadParaActualizar: Requisito): void {
   ...
   delete(entidadParaBorrar: Requisito): void {
   ...
   onSelect(entidadActual: Requisito): void {
