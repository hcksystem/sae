...
import { AsignaturaCupo } from '../../entidades/CRUD/AsignaturaCupo';
...
@Component({
   selector: 'app-asignaturacupo',
   templateUrl: './asignaturacupo.component.html',
   styleUrls: ['./asignaturacupo.component.scss']
})

export class AsignaturaCupoComponent implements OnInit {

   busy: Promise<any>;
   entidades: AsignaturaCupo[];
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: AsignaturaCupoService, private modalService: NgbModal) {
   ...
   refresh(): void {
      ...
      this.entidades = AsignaturaCupo[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
