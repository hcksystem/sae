...
@Component({
   selector: 'app-asignaturasolicitudmatricula',
   templateUrl: './asignaturasolicitudmatricula.component.html',
   styleUrls: ['./asignaturasolicitudmatricula.component.scss']
})

export class AsignaturaSolicitudMatriculaComponent implements OnInit {

   busy: Promise<any>;
   entidades: AsignaturaSolicitudMatricula[];
   ...
   isValid(entidadPorEvaluar: AsignaturaSolicitudMatricula): boolean {
      return true;
   }
   ...
   crearEntidad(): AsignaturaSolicitudMatricula {
      const nuevoAsignaturaSolicitudMatricula = new AsignaturaSolicitudMatricula();
      nuevoAsignaturaSolicitudMatricula.id = 0;
      return nuevoAsignaturaSolicitudMatricula;
   }

   add(entidadNueva: AsignaturaSolicitudMatricula): void {
   ...
   update(entidadParaActualizar: AsignaturaSolicitudMatricula): void {
   ...
   delete(entidadParaBorrar: AsignaturaSolicitudMatricula): void {
   ...
   refresh(): void {
      ...
      this.entidades = AsignaturaSolicitudMatricula[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: AsignaturaSolicitudMatricula): void {
