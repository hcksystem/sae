...
export class DocenteComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: DocenteService) {
   ...
   isValid(entidadPorEvaluar: Docente): boolean {
      return true;
   }
   ...
   crearEntidad(): Docente {
      const nuevoDocente = new Docente();
      nuevoDocente.id = 0;
      return nuevoDocente;
   }

   add(entidadNueva: Docente): void {
   ...
   update(entidadParaActualizar: Docente): void {
   ...
   delete(entidadParaBorrar: Docente): void {
   ...
   onSelect(entidadActual: Docente): void {
