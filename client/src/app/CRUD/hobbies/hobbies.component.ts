...
export class HobbiesComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: HobbiesService) {
   ...
   isValid(entidadPorEvaluar: Hobbies): boolean {
      return true;
   }
   ...
   crearEntidad(): Hobbies {
      const nuevoHobbies = new Hobbies();
      nuevoHobbies.id = 0;
      return nuevoHobbies;
   }

   add(entidadNueva: Hobbies): void {
   ...
   update(entidadParaActualizar: Hobbies): void {
   ...
   delete(entidadParaBorrar: Hobbies): void {
   ...
   onSelect(entidadActual: Hobbies): void {
