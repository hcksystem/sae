...
export class AsignaturaComponent implements OnInit {
   ...
   entidadSeleccionada: Asignatura;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   isValid(entidadPorEvaluar: Asignatura): boolean {
      return true;
   }
   ...
   crearEntidad(): Asignatura {
      const nuevoAsignatura = new Asignatura();
      nuevoAsignatura.id = 0;
      return nuevoAsignatura;
   }

   add(entidadNueva: Asignatura): void {
   ...
   update(entidadParaActualizar: Asignatura): void {
   ...
   delete(entidadParaBorrar: Asignatura): void {
