...
export class ContactoComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ContactoService) {
   ...
   isValid(entidadPorEvaluar: Contacto): boolean {
      return true;
   }
   ...
   crearEntidad(): Contacto {
      const nuevoContacto = new Contacto();
      nuevoContacto.id = 0;
      return nuevoContacto;
   }

   add(entidadNueva: Contacto): void {
   ...
   update(entidadParaActualizar: Contacto): void {
   ...
   delete(entidadParaBorrar: Contacto): void {
   ...
   onSelect(entidadActual: Contacto): void {
