...
import { Contacto } from '../../entidades/CRUD/Contacto';
...
export class ContactoService {
   ...
   getPagina(pagina: number, tamanoPagina: number): Promise<Contacto[]> {
      return this.http.get(this.urlBase+'/leer_paginado' + '?pagina=' + pagina + '&registros_por_pagina=' + tamanoPagina).toPromise().then(response=>response.json() as Contacto[]).catch(this.handleError);
   }
