...
export class CarreraComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: CarreraService) {
   ...
   isValid(entidadPorEvaluar: Carrera): boolean {
      return true;
   }
   ...
   crearEntidad(): Carrera {
      const nuevoCarrera = new Carrera();
      nuevoCarrera.id = 0;
      return nuevoCarrera;
   }

   add(entidadNueva: Carrera): void {
   ...
   update(entidadParaActualizar: Carrera): void {
   ...
   delete(entidadParaBorrar: Carrera): void {
   ...
   onSelect(entidadActual: Carrera): void {
