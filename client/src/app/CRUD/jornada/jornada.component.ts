...
export class JornadaComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: JornadaService) {
   ...
   isValid(entidadPorEvaluar: Jornada): boolean {
      return true;
   }
   ...
   crearEntidad(): Jornada {
      const nuevoJornada = new Jornada();
      nuevoJornada.id = 0;
      return nuevoJornada;
   }

   add(entidadNueva: Jornada): void {
   ...
   update(entidadParaActualizar: Jornada): void {
   ...
   delete(entidadParaBorrar: Jornada): void {
   ...
   onSelect(entidadActual: Jornada): void {
